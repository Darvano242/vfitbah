...
const nextSection = '// SUCCESS / WELCOME ANIMATION';
const startIndex = html.indexOf(start);
const nextSectionIndex = html.indexOf(nextSection, startIndex);

if (startIndex < 0 || nextSectionIndex < 0) {
...
html = html.slice(0, startIndex) + replacement + html.slice(nextSectionIndex);
