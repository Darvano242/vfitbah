...
html=html.replace(appMarker,'    <link rel="stylesheet" href="/vfp-programs.css?v=20260720" data-vfp-programs="1">\n    <script src="/vfp-programs.js?v=20260720"></script>\n\n'+appMarker);
...
const dashboardEl=React.createElement(VFPProgramDashboard,{program:CURRENT_PROGRAM,enrollment:enrollment,currentWeek:currentWeek,completedWorkouts:completedWorkouts,getWorkoutForWeek:getWorkoutForWeek,onSelectWorkout:setSelectedWorkout,onBack:onBack,onWeight:logWeightPrompt,on1RM:open1RMPrompt,onMeal:()=>setShowMealPlan(true),onHistory:openHistory,onNote:openProgramNote,selectedWorkout:selectedWorkout,onExitWorkout:()=>setSelectedWorkout(null),onCompleteWorkout:completeWorkout});
let mealEl=null;
